...
def show_wishlist(_cursor, _user_id):
    ...
    _cursor.execute("SELECT user.user_id, user.first_name, user.last_name, books.book_id, books.book_name, books.author " + 
                    "FROM wishlist " + 
                    "INNER JOIN user ON wishlist.user_id = user.user_id " + 
                    "INNER JOIN book ON wishlist.book_id = books.book_id " + 
